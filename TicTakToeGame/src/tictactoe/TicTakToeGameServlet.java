...
public class TicTakToeGameServlet extends HttpServlet {
  ...
  public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {    
    ...
    Player player= new Player(userService.getCurrentUser().getEmail().toString());
    //String playerKey=KeyFactory.keyToString(player.getKey());
    if (gameKey != null) {
   ...
   // player=pm.getObjectById(Player.class, KeyFactory.stringToKey(playerKey));
